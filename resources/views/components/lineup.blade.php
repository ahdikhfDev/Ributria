            ...
            <template x-for="(artist, idx) in lineup">
                ...
                <div class="group relative border-b border-white/10 py-10 cursor-pointer transition-all duration-300"
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between relative z-20 mix-blend-difference">
                        ...
                        <div class="flex items-center gap-4 mt-2 md:mt-0 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div class="md:hidden mt-6 w-full max-w-sm relative rounded-lg overflow-hidden border border-white/10 shadow-lg"
                        ...
                        <!-- Overlay Warna Tema -->
                        <div class="absolute inset-0 mix-blend-multiply opacity-50" :style="`background-color: ${activeTheme.primary}`"></div>
                        
                        <!-- Badge Genre -->
                        <div class="absolute bottom-2 right-2 bg-black/80 px-2 py-1 text-[10px] font-mono text-white border border-white/20">
                            <span x-text="artist.genre"></span>
                        </div>
                    </div>
