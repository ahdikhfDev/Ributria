<section id="tickets" class="py-24 relative z-10" :style="`background-color: ${activeTheme.bg}`">
    ...
    <div x-show="checkoutOpen" 
         ...
         style="display: none;"> <!-- display:none agar tidak flash saat load -->
                ...
                <form action="{{ route('ticket.checkout') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <button type="button" @click="if(checkoutForm.qty < 10) checkoutForm.qty++" class="w-12 h-12 bg-gray-800 text-white font-bold hover:bg-gray-700 rounded transition-colors">+</button>
                        </div>
                    </div>
